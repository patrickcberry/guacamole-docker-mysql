...
docker exec --privileged ras-mysql mysql --connect-expired-password -u root --password=\""$otpw"\" < \"ALTER USER \'root\'@\'localhost\' IDENTIFIED BY \'"$mysql_password"\'; FLUSH PRIVILEGES; EXIT;\"
